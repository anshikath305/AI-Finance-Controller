...
class CopilotQueryLayer:
    def __init__(self):
        ...
        self.control_service = ControlHealthService()
    ...
    def get_control_health(self, db: Session, run_id: int) -> Dict[str, Any]:
        return self.control_service.get_run_controls(db, run_id)
